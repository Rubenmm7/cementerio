...
public class UserController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<UserResponseDTO> actualizar(@PathVariable Long id, @RequestBody UserRequestDTO userRequestDTO) {
        return userService.actualizar(id, userRequestDTO)
